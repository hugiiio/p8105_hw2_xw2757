...
```{r}
baby_names <- 
  read_csv(file = "Popular_Baby_Names.csv", col_types ="iffcii") %>% 
  janitor::clean_names()

str(baby_names)
levels(baby_names$gender)
levels(baby_names$ethnicity)
...
baby_names %>% 
  ...
  distinct(childs_first_name, year_of_birth, .keep_all = TRUE)
```
